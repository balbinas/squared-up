...
declare type MaybeIsComponent = IDestroyable & {
    isComponent?: boolean;
    tagName?: string;
    _currentState?: any;
    _states?: any;
...
declare type TargetOrString = EventTarget | string;
declare const _default: Mixin<{
     ...
     * @public
     */
    addEventListener(this: MaybeIsComponent, target: TargetOrString, eventName: string, callback: RunMethod<MaybeIsComponent, any>, options?: Object | undefined): void;
    /**
     ...
     * @public
     */
    removeEventListener(this: MaybeIsComponent, target: TargetOrString, eventName: string, callback: RunMethod<MaybeIsComponent, any>, options?: Object | undefined): void;
    destroy(): void;
