...
declare const _default: Mixin<{
     ...
     * @public
     */
    runTask(taskOrName: TimerHandler, timeout?: number): import("../types").Timer;
    /**
     ...
     * @public
     */
    cancelTask(cancelId: number): void;
    /**
     ...
     * @public
     */
    scheduleTask(queueName: import("@ember/runloop/-private/types").EmberRunQueues, taskOrName: TimerHandler, ...args: any[]): import("../types").Timer;
    /**
     ...
     * @public
     */
    debounceTask(name: string, ...debounceArgs: any[]): void;
    /**
     ...
     * @public
     */
    cancelDebounce(name: string): void;
    /**
     ...
     * @public
     */
    throttleTask(name: string, timeout: number): import("../types").Timer;
    /**
     ...
     * @public
     */
    cancelThrottle(cancelId: number): void;
    /**
     ...
     * @public
     */
    pollTask(taskOrName: TimerHandler, token: string | number): string | number;
    /**
     ...
     * @public
     */
    cancelPoll(token: string | number): void;
    destroy(): void;
