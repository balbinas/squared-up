import { IDestroyable, IMap, TaskOrName, Timer, EmberRunTimer, EmberRunQueues } from './types';
/**
 ...
 * @public
 */
export declare function runTask(destroyable: IDestroyable, taskOrName: TaskOrName, timeout?: number): Timer;
/**
 ...
 * @public
 */
export declare function scheduleTask(destroyable: IDestroyable, queueName: EmberRunQueues, taskOrName: TaskOrName, ...args: any[]): Timer;
/**
 ...
 * @public
 */
export declare function throttleTask(destroyable: IDestroyable, taskName: any, ...throttleArgs: any[]): Timer;
/**
 ...
 * @public
 */
export declare function cancelTask(cancelId: Timer): void | undefined;
export declare function cancelTask(destroyable: IDestroyable, cancelId: Timer): void | undefined;
