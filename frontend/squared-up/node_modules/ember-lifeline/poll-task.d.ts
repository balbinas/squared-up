...
export declare let queuedPollTasks: {
    [k: string]: () => void;
};
/**
 ...
 * @public
 */
export declare function cancelPoll(token: Token): void | undefined;
export declare function cancelPoll(destroyable: IDestroyable, token: Token): void | undefined;
